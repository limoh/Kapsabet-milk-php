...
<form action='' method='POST' class="form-horizontal" name="delivery"> 
    <div class="control-group">
        ...
        <div class="controls">
            <input id="f_no" class="input-xlarge" type="text" placeholder="Farmer Number" name='r_f_no' value='<?php echo stripslashes($row['r_f_no']) ?>'/> 
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="___KG" name='r_kg' value='<?php echo stripslashes($row['r_kg']) ?>'/> 
    ...
    <div class="control-group">
        ...
        <div id="datetimepicker1" class="controls input-append date" style="margin-left: 20px">
            <input class="input-xlarge" type="text" data-format="yyyy-mm-dd hh:mm:ss"  placeholder="Date and Time" name='r_dt' value='<?php echo stripslashes($row['r_dt']) ?>'/> 
            <span class="add-on">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Name" name='r_deliverer' value='<?php echo stripslashes($row['r_deliverer']) ?>'/> 
        </div>
    </div>
    <div class="control-group">
