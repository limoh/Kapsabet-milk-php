...
<form action='' method='post' class="form-horizontal"> 
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Unique Number" name='f_no'/>
<?php echo $validation['no'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Enter National ID" name='f_id'/> 
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Enter both names" name='f_name'/> 
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="f_locallity"> Locality of Farmer:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Residential area" name='f_locallity'/> 
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="0712345678" name='f_phone'/> 
        </div>
    </div>
    <div class="control-group">
